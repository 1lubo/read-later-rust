...
#[test]
#[ignore = "step 5: parse <title> from the document"]
fn extracts_title() {
...
#[test]
#[ignore = "step 5: prefer <meta name=description> for the excerpt"]
...
#[test]
#[ignore = "step 5: fall back to og:description when no meta description"]
...
#[test]
#[ignore = "step 5: fall back to the first non-empty <p> when no meta tags"]
...
#[test]
#[ignore = "step 5: missing title/excerpt yield None, not empty strings"]
